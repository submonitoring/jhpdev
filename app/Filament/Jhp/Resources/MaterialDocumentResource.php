...
namespace App\Filament\Jhp\Resources;

use App\Filament\Jhp\Clusters\MaterialDocument as ClustersMaterialDocument;
use App\Filament\Jhp\Resources\MaterialDocumentResource\Pages;
use App\Filament\Jhp\Resources\MaterialDocumentResource\RelationManagers;
...
class MaterialDocumentResource extends Resource
{
    ...
    protected static ?int $navigationSort = 832000000;
