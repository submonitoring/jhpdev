...
use App\Filament\Jhpadmin\Resources\MaterialMasterPlantResource\Pages;
use App\Filament\Jhpadmin\Resources\MaterialMasterPlantResource\RelationManagers;
use App\Filament\Submonitoring\Resources\MaterialMasterPlantResource as ResourcesMaterialMasterPlantResource;
...
class MaterialMasterPlantResource extends Resource
{
    ...
    protected static ?int $navigationSort = 834000020;
    ...
    {
        return ResourcesMaterialMasterPlantResource::form($form);
    }

    public static function table(Table $table): Table
    {
        return ResourcesMaterialMasterPlantResource::table($table);
    }
