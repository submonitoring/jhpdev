...
class BusinessPartnerCompanyExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('cust_account_assignment_group_id'),
            ExportColumn::make('cust_tax_classification_id'),
            ExportColumn::make('cust_currency_id'),
            ExportColumn::make('cust_payment_term_id'),
            ExportColumn::make('vend_account_assignment_group_id'),
            ExportColumn::make('vend_tax_classification_id'),
            ExportColumn::make('vend_currency_id'),
            ExportColumn::make('vend_payment_term_id'),
