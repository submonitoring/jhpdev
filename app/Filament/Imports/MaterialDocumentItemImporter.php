...
class MaterialDocumentItemImporter extends Importer
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ImportColumn::make('plant_id')
                ->numeric()
                ->rules(['integer']),
            ImportColumn::make('material_document_id')
                ->numeric()
                ->rules(['integer']),
            ImportColumn::make('text_item'),
    ...
    {
        $body = 'Your material document item import has completed and ' . number_format($import->successful_rows) . ' ' . str('row')->plural($import->successful_rows) . ' imported.';
